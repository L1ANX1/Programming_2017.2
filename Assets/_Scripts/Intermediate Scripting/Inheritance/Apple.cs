...
public class Apple : Fruit
{
    ...
    public Apple()
    {
        // Notice how Apple has access to the public variable color,
        // which is a part of the parent Fruit class.
        color = "red";
    ...
    {
        // Notice how this constructor doesn't set the color since the base constructor
